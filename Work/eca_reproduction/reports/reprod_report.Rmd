...
* Some confiugrations use grouping of seasons. The way to do this is not documented in stox. 
...
In order to get a closer reproduction, I ran the estimate without boat effect (platform as a random effect). This is not what was done in the estimate that Sondre sent, and the reasons for this discrepancy should be identified.
