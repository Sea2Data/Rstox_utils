...
ECA 3.x estimate from 2017. Model was configured and run by Sondre Aanes and results provided by Are Salthaug. From Sondres notes, I have konfigured the model with only temporal (season) and platform (boat) as covariates. Quarter 2-4 was collapsed to one value.
...
```{r kolmule sd, fig.cap={"Estimates for sd of posteried distribution of catch in millions per age group of blue whiting in 2017."}, echo=FALSE}
