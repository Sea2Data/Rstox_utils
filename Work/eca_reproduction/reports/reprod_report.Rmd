...
ECA 3.x estimate from 2018. Model was configured and run by Sondre Aanes who provided results for reproduction analysis. ECA 3.x .param files was not kept, but a detailed log of data corrections done by ECA 3.x was provided. However, 1964 individuals were listed as removed for 'unkown reason'. I could not find a way to identify these. Total numver of individuals in StoX-Reca run was ~4K, total number in ECA 3.x sample overview was ~2K.
