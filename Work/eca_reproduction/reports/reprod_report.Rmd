...
The estimation shows a sever discrepancy for age 1. Inspection of data used reveals that there is likely less data in the StoX-Reca run (50 stations). This might be due to data massaging or imputation not implemented in. I will investigate this further and update the haddock reproduction analysis.
