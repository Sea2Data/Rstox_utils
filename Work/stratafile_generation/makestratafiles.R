...
#
# area merge for RECA makrell 2018, based on Sondre Aanes parameter file for ECA 3.x
#
makrellmapping <- list()
...
save_neighbours(makrell2018_neighbours, file.path("output", "RECA_makrell_2018_neighbours.txt"))
#
